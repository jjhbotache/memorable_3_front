...
export default function UsSlider() {
  ...
  const imgs = [
    "https://res.cloudinary.com/db8fpml9m/image/upload/v1727469687/memorable_empaque_ibague_ekkua5.png",
    ...
    "https://res.cloudinary.com/db8fpml9m/image/upload/v1727469685/memorable_empaque_nacional_v2tbbu.png",
